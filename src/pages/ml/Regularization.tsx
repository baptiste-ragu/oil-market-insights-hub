...
import { Brain, Target, ArrowLeft } from 'lucide-react';
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between h-16">
            <div className="flex items-center">
              ...
              <span className="ml-2 text-xl font-bold text-gray-900">Regularization Techniques</span>
            </div>
          </div>
        </div>
      </nav>
          ...
          <CardContent>
            <div className="bg-purple-50 p-8 rounded-lg text-center">
              ...
              <p className="text-purple-700">
                LASSO, Ridge, and Elastic Net regularization with commodity-specific applications.
              </p>
            </div>
          </CardContent>
        </Card>
