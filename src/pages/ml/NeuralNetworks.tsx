        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between h-16">
            <div className="flex items-center">
              ...
              <span className="ml-2 text-xl font-bold text-gray-900">Neural Networks</span>
            </div>
          </div>
        </div>
      </nav>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Deep learning and LSTM time series forecasting
            </CardDescription>
          </CardHeader>
          <CardContent>
            <div className="bg-purple-50 p-8 rounded-lg text-center">
              ...
              <p className="text-purple-700">
                Deep learning architectures, LSTM/GRU models, and feature engineering.
              </p>
            </div>
          </CardContent>
        </Card>
