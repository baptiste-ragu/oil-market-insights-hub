...
import { TrendingUp, Globe, BarChart3, PieChart, ArrowLeft } from 'lucide-react';
          ...
          <div className="flex justify-between h-16">
            <div className="flex items-center">
              <Link to="/" className="flex items-center space-x-2 mr-6">
                ...
                <span className="text-sm text-blue-600">Back to Hub</span>
              </Link>
              <BarChart3 className="h-8 w-8 text-blue-600" />
              <span className="ml-2 text-xl font-bold text-gray-900">Global Oil Markets</span>
            </div>
          </div>
        </div>
      </nav>
            ...
            <div>
              ...
              <div className="flex flex-wrap gap-4">
                <Button asChild size="lg" className="bg-white text-blue-900 hover:bg-gray-100">
                  <Link to="/oil/fundamentals">Explore Fundamentals</Link>
                </Button>
                <Button asChild variant="outline" size="lg" className="border-white text-white hover:bg-white hover:text-blue-900">
                  <Link to="/oil/reserves">View Data</Link>
                </Button>
              </div>
            </div>
