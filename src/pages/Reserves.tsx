...
const opecData = [
  ...
  { country: 'Other OPEC', production: 3428, percentage: 9.7 },
];
            ...
            <ResponsiveContainer width="100%" height={400}>
              <BarChart data={productionData} margin={{ top: 20, right: 30, left: 20, bottom: 5 }}>
                ...
                <Tooltip 
                  ...
                  labelFormatter={(label) => productionData.find(item => item.country === label)?.flag + ' ' + label}
                />
      ...
      <div className="mb-12">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          <Card>
            ...
            <CardContent>
              <ResponsiveContainer width="100%" height={300}>
                <BarChart data={opecData.slice(0, 5)} layout="horizontal">
                  <CartesianGrid strokeDasharray="3 3" />
                  <XAxis type="number" />
