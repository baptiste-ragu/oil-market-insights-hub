...
import { Car, Factory, Plane, Home, TrendingUp, Globe } from 'lucide-react';
import PeakOilDemand from '@/components/PeakOilDemand';
...
const Consumption = () => {
  ...
  return (
    <Layout 
      ...
      description="Analysis of worldwide oil demand by sector, region, and consumption trends"
    >
      ...
      <div className="space-y-12">
        ...
        <div className="mb-12">
          <h2 className="text-2xl font-bold text-gray-900 mb-6">Global Consumption by Sector</h2>
          <Card>
            <CardHeader>
